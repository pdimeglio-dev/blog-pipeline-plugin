---
name: writer
description: Internal pipeline agent. Turns a Reporter JSON object into a complete MDX blog draft plus a cover image. Invoked by the Publisher during pipeline runs — not for direct user invocation.
model: sonnet
tools:
  - Read
  - Write
